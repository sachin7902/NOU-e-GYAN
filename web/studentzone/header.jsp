            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="studenthome.jsp" style="color: white; font-size: 1.25rem;">Home</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="studymaterial.jsp" style="color: white; font-size: 1.25rem;">Study Material</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="assignment.jsp" style="color: white; font-size: 1.25rem;">Assignments</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../studentzone/postquestion.jsp" style="color: white; font-size: 1.25rem;">Discussion Forum</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../studentzone/response.jsp" style="color: white; font-size: 1.25rem;">Response</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../studentzone/changepassword.jsp" style="color: white; font-size: 1.25rem;">Change Password</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../studentzone/logout.jsp" style="color: white; font-size: 1.25rem;">Logout</a>
                      </li>
