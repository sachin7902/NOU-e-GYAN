<%-- 
    Document   : header
    Created on : 14 Oct, 2023, 9:52:31 AM
    Author     : skuma
--%>
...
<html>
    ...
    <div style="background: linear-gradient(rgba(24, 24, 24, 0.5),rgba(28, 27, 27, 0.5));">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="adminhome.jsp" style="color: white; font-size: 1.0rem;">Home</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="studentinfo.jsp" style="color: white; font-size: 1.0rem;">Student Management</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="enquirymgmt.jsp" style="color: white; font-size: 1.0rem;">Enquiry Management</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="feedbackmgmt.jsp" style="color: white; font-size: 1.0rem;">FeedBack Management</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="complainmgmt.jsp" style="color: white; font-size: 1.0rem;">Complaint Management</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="uploadmaterial.jsp" style="color: white; font-size: 1.0rem;">Study Material</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="changepassword.jsp" style="color: white; font-size: 1.0rem;">Change Password</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="logout.jsp" style="color: white; font-size: 1.0rem;">Logout</a>
                      </li>
