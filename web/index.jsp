...
<body>
    ...
    <div class="row col-sm-12 my-3" style="background-color: rgb(237, 192, 108);">
      ...
      <div class="row col-sm-12 my-3">
        ...
        <div class="col-sm-4 px-5 ">
            <h6 class=" px-5" style="background-color: rgb(201, 76, 19); color:white;">
                News Text : <%=rs.getString("newstext")%>
                <br/>
                Posted Date : <%=rs.getString("posteddate")%>
    ...
    <div class="row col-sm-12" style="background-color: rgb(109, 13, 13);">
       ...
       <div class="row" style="background-color: rgb(75, 6, 6);">
        <div class="col-sm-12">
            <h4 style="color:white; text-align: center; ">&copy; Designed and Developed by Sachin</h4>
        </div>
       </div> 
    </div>
    <!-- footer end -->
